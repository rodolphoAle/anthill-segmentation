"""Domain data classes for evaluation and validation metrics."""
...
from app.domain.mask_utils import LABEL_ANTHILL, LABEL_BACKGROUND, LABEL_IGNORE


@dataclass
class ValidationMetrics:
    """Aggregated metrics from a streaming validation run."""
