...
**Por que aplicado:**
- **Estabiliza o treinamento:** sem BatchNorm, gradientes podem explodir ou sumir em redes profundas
...
**Por que aplicado:** com ConvTranspose2d, o modelo aprende **como** reconstruir a resolução de modo otimizado para a tarefa, não apenas "esticar" a imagem. Em conjunto com BatchNorm, este é um salto qualitativo significativo.
...
**Por que aplicado:** sem BatchNorm, gradientes podem explodir e produzir Inf/NaN, corrompendo os pesos. Com BatchNorm, o problema é menor mas o clipping continua como rede de segurança.
